...
public class Licence {
    ...
    private Licence upgradeFromLicence;

    public Licence() {
    }

    public Licence(int licenceId, String licenceClass, String description, int minimumAge, int validForYears,
            Integer upgradeFromLicenceId) {
    ...
    public Licence getUpgradeFromLicence() {
        return upgradeFromLicence;
    }

    public void setUpgradeFromLicence(Licence upgradeFromLicence) {
        this.upgradeFromLicence = upgradeFromLicence;
    }
}
