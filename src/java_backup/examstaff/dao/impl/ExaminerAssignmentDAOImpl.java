...
public class ExaminerAssignmentDAOImpl extends DBContext implements ExaminerAssignmentDAO {
    ...
    static String examTypeFromId(int examTypeId) {
        return switch (examTypeId) {
            case 2 ->
                shared.enums.ExamSection.THUC_HANH_TRONG_HINH.getDisplayName();
            case 4 ->
                shared.enums.ExamSection.THUC_HANH_TREN_DUONG.getDisplayName();
            default ->
                shared.enums.ExamSection.LY_THUYET.getDisplayName();
        };
    }
