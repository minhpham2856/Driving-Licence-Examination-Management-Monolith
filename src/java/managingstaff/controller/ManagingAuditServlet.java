...
public class ManagingAuditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int total = auditDAO.countUserLogs(
                currentUser.getUserId(), keyword, action, startDate, endDate);
        ...
        request.setAttribute("approvedCount",
                auditDAO.countUserLogs(currentUser.getUserId(), "Approved hồ sơ", "", startDate, endDate)
                + auditDAO.countUserLogs(currentUser.getUserId(), "", "APPROVE", startDate, endDate));
        request.setAttribute("supplementCount",
                auditDAO.countUserLogs(currentUser.getUserId(), "NeedSupplement hồ sơ", "", startDate, endDate));
        request.setAttribute("exportCount",
                auditDAO.countUserLogs(currentUser.getUserId(), "", "EXPORT", startDate, endDate));
