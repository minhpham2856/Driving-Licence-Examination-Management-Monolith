...
/**
 * Lớp hỗ trợ thao tác {@code ExamEnrollmentSection} trên schema DLEM_DB_2:
 * tra cứu section LT/TH và cập nhật phân phòng.
 */
final class ExamEnrollmentSectionSupport {
    ...
    /** Tìm {@code ExamSectionId} phần lý thuyết theo kỳ thi. */
    ...
    /** Tìm {@code ExamSectionId} phần thực hành theo kỳ thi. */
    ...
    /** Tìm {@code ExamSectionId} lý thuyết đã gắn với một {@code ExamEnrollment}. */
    ...
    /** Tìm {@code ExamSectionId} thực hành đã gắn với một {@code ExamEnrollment}. */
