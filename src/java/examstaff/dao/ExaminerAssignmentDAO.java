...
/**
 * DAO phân công sát hạch viên theo kỳ thi ({@code Exam}).
 * Đọc/ghi bảng {@code ExaminerSchedule}, kèm JOIN {@code [User]}, {@code Profile},
 * {@code ExamArea}, {@code ExamSection}; một số thao tác ghi thêm {@code Audit}.
 */
