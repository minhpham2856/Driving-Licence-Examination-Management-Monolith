...
/**
 * DAO đăng ký / hồ sơ thí sinh trong kỳ thi ({@code Candidate} + {@code ExamEnrollment}).
 * Đọc bằng {@link Db2CandidateSql#CANDIDATE_SELECT}; ghi trên Candidate, Payment,
 * ExamEnrollmentSection, ExamResult, ExamScore… theo từng thao tác.
 */
