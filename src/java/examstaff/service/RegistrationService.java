...
/**
 * Facade CRUD đăng ký thí sinh kỳ thi — lớp service mỏng trên ExamRegistrationDAO.
 *
 * Phân tách với hàng đợi UI:
 * - <b>Workflow / mutate</b> — getById, getCandidatesByExam,
 *       updatePresent, updatePayment, updateAllocatedRoom,
 *       điểm, ảnh, vắng mặt, đình chỉ…
 * - <b>UI hàng đợi staff</b> — dùng StaffCallService.listQueueByExamId
 *       (View DAO, tối ưu cho màn gọi số); <b>không</b> dùng getCandidatesByExam
 * Các facade khác (ProcedureService, AllocationService) inject service này
