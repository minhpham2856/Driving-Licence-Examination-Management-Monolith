...
import DAOs.Impl.ManagementReportDAOImpl;
...
public class ManagementReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int absent = rows.stream().mapToInt(ManagementReportRowDTO::getAbsentCount).sum();
        int pending = rows.stream().mapToInt(ManagementReportRowDTO::getPendingCount).sum();
        ...
        request.setAttribute("totalAbsent", absent);
