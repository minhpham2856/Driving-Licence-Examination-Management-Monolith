...
import service.RegistrantRegisterExamService;
...
import util.registrant.RegistrantFilterSupport.SessionListFilterState;
...
public class RegistrantRegisterExamServiceImpl implements RegistrantRegisterExamService {
    ...
    public String submitRegistration(User user, HttpServletRequest request) {
        ...
        var docs = documentdao.listByProfileId(profile.getId());
