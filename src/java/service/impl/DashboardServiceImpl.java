...
public class DashboardServiceImpl implements DashboardService {
    ...
    @Override
    public List<AuditRowDTO> getRecentActivities(int limit) {
        ...
        List<AuditRowDTO> list = new ArrayList<>();
        SimpleDateFormat fmt = new SimpleDateFormat("dd/MM/yyyy HH:mm");
        for (Audit log : logs) {
            AuditRowDTO r = new AuditRowDTO();
            ...
            r.setIpAddress("—");
            r.setStatus("Thành công");
            r.setStatusKey("success");
            list.add(r);
        }
        return list;
    }
