...
public class ExamEnrollment {
    ...
    public ExamEnrollment(int examEnrollmentId, int candidateId, int examId,
            String sectionStatus, boolean signaturePrinted, Integer examDeviceId) {
    ...
    /** Alias tương thích UI/URL cũ: sessionId = examId. */
