...
import admin.constants.AuditEntityLabels;
import admin.dao.AuditLogDAO;
import admin.dao.impl.AuditLogDAOImpl;
import admin.model.AuditLog;
...
public final class AuditLogHelper {
    ...
    private static void insertLog(HttpSession session, String action, String contextDetails,
        ...
        try {
            User user = SessionUtil.adaptUser(session != null ? session.getAttribute("user") : null);
