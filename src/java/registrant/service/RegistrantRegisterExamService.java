...
/**
 * Hợp đồng service wizard đăng ký nguyện vọng ngày thi (RegisterExamServlet).
 * Chỉ chạy khi hồ sơ + hạng GPLX đã Approved; đọc ExamDates, lọc ca còn chỗ. POST ghi RegistrationDates (MERGE) — không tạo Candidate, Payment hay SePay checkout.
 */
public interface RegistrantRegisterExamService {
    ...
    /** Trả về null nếu thành công; ngược lại thông báo lỗi tiếng Việt. */
