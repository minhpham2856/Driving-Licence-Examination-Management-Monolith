...
/**
 * Hợp đồng service trang cài đặt tài khoản (SettingsServlet).
 * Hiển thị tóm tắt hồ sơ và đổi mật khẩu trên bảng User.
 * Không cho thí sinh tự vô hiệu hóa tài khoản — quyền thuộc Ban quản lý. Không xử lý thanh toán hay SePay.
 */
