...
/**
 * Trang cài đặt tài khoản — GET/POST /registrant/settings, forward
 * settings.jsp. GET: RegistrantSettingsService.applySettingsView gắn userEmail,
 * tóm tắt hồ sơ/CCCD và số ca đang đăng ký. POST formId=password: đổi mật khẩu.
 * Thí sinh không được vô hiệu hóa tài khoản (chỉ Ban quản lý). Lỗi ghi error và
 * forward lại JSP; thành công redirect ?success=1. Không xử lý Payment/SePay.
 */
