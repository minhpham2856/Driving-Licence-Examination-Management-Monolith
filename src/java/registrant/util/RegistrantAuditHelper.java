...
import registrant.util.RegistrantAuditLogHelper;
import registrant.util.AuditLogViewHelper;
...
public final class RegistrantAuditHelper {
    ...
    public static void logExamCancellationRequest(HttpSession session, int profileId,
        ...
        RegistrantAuditLogHelper.persistForEntity(session, "ExamRegistration", "REQUEST", detail,
    ...
    public static List<Map<String, Object>> toAuditViewRows(List<AuditLogEntry> auditLogs) {
        if (auditLogs == null || auditLogs.isEmpty()) {
            return Collections.emptyList();
        }
