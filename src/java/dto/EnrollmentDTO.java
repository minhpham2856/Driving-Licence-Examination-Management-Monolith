...
public class EnrollmentDTO {
    ...
    public void setIsPaymentCompleted(boolean paymentCompleted) { this.paymentCompleted = paymentCompleted; }
    
    public boolean isValidCapturedPhoto() { return validCapturedPhoto || (candidate != null && candidate.getPhotoImageUrl() != null && !candidate.getPhotoImageUrl().isEmpty()); }
    public void setValidCapturedPhoto(boolean validCapturedPhoto) { this.validCapturedPhoto = validCapturedPhoto; }
    
    public int getAllocatedAreaId() { return allocatedAreaId; }
    public void setAllocatedAreaId(int allocatedAreaId) { this.allocatedAreaId = allocatedAreaId; }
    
    public String getAllocatedAreaName() { return allocatedAreaName; }
    public void setAllocatedAreaName(String allocatedAreaName) { this.allocatedAreaName = allocatedAreaName; }
    
    public String getNotes() { return notes; }
    public void setNotes(String notes) { this.notes = notes; }
    
    public Integer getTheoryScore() { return theoryScore; }
    public void setTheoryScore(Integer theoryScore) { this.theoryScore = theoryScore; }
    ...
    public Integer getRoadTestScore() { return roadTestScore; }
    public void setRoadTestScore(Integer roadTestScore) { this.roadTestScore = roadTestScore; }
    
    public boolean isPresent() { return present || (candidate != null && !candidate.isAbsent()); }
    public void setIsPresent(boolean present) { this.present = present; if (candidate != null) candidate.setAbsent(!present); }
    
    public String getTheoryPassed() { return theoryPassed; }
    public void setTheoryPassed(String theoryPassed) { this.theoryPassed = theoryPassed; }
    
    public String getPracticalPassed() { return practicalPassed; }
    public void setPracticalPassed(String practicalPassed) { this.practicalPassed = practicalPassed; }
    
    public String getRoadTestPassed() { return roadTestPassed; }
    public void setRoadTestPassed(String roadTestPassed) { this.roadTestPassed = roadTestPassed; }
