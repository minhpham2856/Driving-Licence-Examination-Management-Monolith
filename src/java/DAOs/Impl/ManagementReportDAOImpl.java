...
import DAOs.ManagementReportDAO;
        ...
        String sql = """
                WITH CandidateAggregate AS (
                    SELECT e.ExamId, e.ExamCode, e.ExamDate, l.LicenceClass,
                           ...
                           COUNT(DISTINCT ec.SessionId) AS AssignmentCount,
                    ...
                    LEFT JOIN Exam_Candidate ec ON ec.ExamId = e.ExamId
                    LEFT JOIN Candidate c ON c.CandidateId = ec.CandidateId
                    LEFT JOIN ExamResult er ON er.ExamCandidateId = ec.ExamCandidateId
                %s
                    ...
                    SELECT ExamId, ExamCode, ExamDate, LicenceClass, CandidateId, IsAbsent,
                           ...
                           CASE WHEN IsAbsent = 0 AND MinimumResult = 0
                ...
                SELECT %s AS PeriodLabel,
                       o.LicenceClass,
                       COUNT(*) AS TotalCount,
                       SUM(o.IsAbsent) AS AbsentCount,
                       SUM(o.IsPassed) AS PassCount,
                       SUM(o.IsFailed) AS FailCount,
                       SUM(CASE WHEN o.IsAbsent = 0 AND o.IsPassed = 0 AND o.IsFailed = 0
