...
import service.impl.RegistrantUploadServiceImpl;
...
public class UploadDocumentsServlet extends HttpServlet {
    ...
    private void handleRequestApproval(User user, HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    private void handleDeleteDocument(User user, HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    private void renderPage(User user, HttpServletRequest request, HttpServletResponse response, String error)
            throws ServletException, IOException {
        if (error != null) {
