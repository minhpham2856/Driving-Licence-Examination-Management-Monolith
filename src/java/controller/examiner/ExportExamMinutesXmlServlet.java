...
import java.io.OutputStream;
 ...
 // Servlet that exports exam minutes (bien ban) as an XML file.
...
public class ExportExamMinutesXmlServlet extends ExaminerExportServlet {
    ...
    // Service responsible for assembling the minutes export payload with metadata
    private final ExaminerExportService exportService = new ExaminerExportServiceImpl();

    // Handles the GET request to generate and download the exam minutes XML file
    @Override
