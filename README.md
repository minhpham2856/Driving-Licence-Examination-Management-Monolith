...
## 1. Architecture: Feature Modules Over Shared Core

The codebase is structured into self-contained feature modules (`auth`, `examiner`, `general`, `examstaff`, `registrant`, ...) over a shared core.
