...
p = root / "src/java/examiner/service/impl/EnrollmentServiceImpl.java"
p.write_text(p.read_text(encoding="utf-8").replace("candidate.isFemale()", "candidate.isSex()"), encoding="utf-8", newline="\n")
