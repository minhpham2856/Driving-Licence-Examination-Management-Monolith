    ...
    <main class="main-content">
        ...
        <header class="page-header">
            <div class="page-title-wrap">
                ...
                <p class="page-subtitle">Cấp phát tài khoản mới, phân quyền truy cập và kiểm soát trạng thái hoạt động. Mật khẩu do hệ thống sinh tự động; người dùng tự đổi khi đăng nhập lần đầu.</p>
            </div>
            <div class="page-actions" style="display: flex; gap: 10px;">
                ...
                <button type="button" class="btn-filter" id="btn-add-account" onclick="openAccModal()" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; flex: none; cursor:pointer;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    Tạo tài khoản mới
                </button>
            </div>
        </header>
        ...
        <section class="metrics-row" aria-label="Thống kê tài khoản">
            ...
            <div class="stat-card"><div class="stat-icon stat-icon--blue" style="background-color: rgba(0, 82, 204, 0.08); color: #0052cc;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
            ...
            <div class="stat-card"><div class="stat-icon stat-icon--blue" style="background-color: rgba(13, 148, 136, 0.08); color: #0d9488;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 22s2-4 10-4 10 4 10 4M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
            ...
            <div class="stat-card"><div class="stat-icon stat-icon--blue" style="background-color: rgba(124, 58, 237, 0.08); color: #7c3aed;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 20h9M3 20v-8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v8M3 10V6a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
        ...
        <section class="filter-panel" aria-label="Bộ lọc tài khoản">
            <h2 class="filter-title"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Bộ lọc tìm kiếm</h2>
            <form action="${ctx}/admin/accounts" method="GET">
                <div class="filter-grid" style="grid-template-columns: 2fr 1.25fr 1.25fr 1.5fr;">
                    ...
                    <div class="input-group filter-grid__btn-col">
                        <div class="btn-group">
                            <button type="submit" class="btn-filter"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg> Lọc</button>
        ...
        <section class="log-card" aria-label="Danh sách tài khoản">
            <header class="log-card-header">
                <h2 class="log-card-title"><svg width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg" style="color: #0052cc;"><circle cx="8" cy="5" r="3.5" stroke="currentColor" stroke-width="2"/><path d="M1 16C1 12.69 4.13 10 8 10C11.87 10 15 12.69 15 16" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
                    Danh sách tài khoản hệ thống
                    <c:if test="${not empty accounts}"><span style="font-size: 0.78rem; font-weight: 600; background: rgba(0,82,204,0.08); color: #0052cc; padding: 2px 10px; border-radius: 9999px; margin-left: 6px;">${fn:length(accounts)} tài khoản</span></c:if>
                </h2>
                <div class="log-card-actions"><button class="btn-export"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2M6 14h12v8H6v-8z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/></svg> In danh sách</button></div>
            </header>
                        ...
                        <c:choose>
                            <c:when test="${not empty accounts}">
                                <c:forEach var="acc" items="${accounts}" varStatus="status">
                                    <tr>
                                        ...
                                        <td style="text-align: center; font-size: 0.82rem; color: #64748b; font-weight: 500;"><fmt:formatDate value="${acc.createdAt}" pattern="dd/MM/yyyy"/></td>
                                        <td style="text-align: center;">
                                            <c:choose>
                                        ...
                                        <td>
                                            <div style="display: flex; gap: 6px; justify-content: center; flex-wrap: wrap;">
                                                <c:choose>
                                                    <c:when test="${acc.status eq 'active'}"><button type="button" class="btn-export" style="padding: 4px 10px; font-size: 0.8rem; border-radius: 6px; border-color: rgba(239,68,68,0.25); color: #dc2626; cursor:pointer;" onclick="lockAccount('${acc.id}', '${fn:escapeXml(acc.fullName)}', true)">Khóa</button></c:when>
                                                    <c:otherwise><button type="button" class="btn-export" style="padding: 4px 10px; font-size: 0.8rem; border-radius: 6px; border-color: rgba(16,185,129,0.25); color: #059669; cursor:pointer;" onclick="lockAccount('${acc.id}', '${fn:escapeXml(acc.fullName)}', false)">Mở khóa</button></c:otherwise>
                                                </c:choose>
                                                <button type="button" class="btn-export" style="padding: 4px 10px; font-size: 0.8rem; border-radius: 6px; border-color: rgba(2,132,199,0.25); color: #0284c7; cursor:pointer;" onclick="resetAccount('${acc.id}', '${fn:escapeXml(acc.username)}')">Cấp lại MK</button>
                                                <button type="button" class="btn-export" style="padding: 4px 10px; font-size: 0.8rem; border-radius: 6px; border-color: rgba(100,116,139,0.25); color: #475569; cursor:pointer;" onclick="deleteAccount('${acc.id}', '${fn:escapeXml(acc.fullName)}')">Xóa</button>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
                            ...
                            <c:otherwise>
                                <tr><td colspan="8" style="text-align: center; padding: 5rem 1.5rem; color: #64748b; font-weight: 500;">
                                    ...
                                    <p style="font-size: 0.82rem; font-weight: 400; color: #94a3b8; margin-top: 0.5rem; max-width: 440px; margin-left: auto; margin-right: auto;">Nhấn nút <strong>Tạo tài khoản mới</strong> để cấp phát thông tin đăng nhập và phân quyền cho người dùng.</p>
                                </td></tr>
                            </c:otherwise>
                        </c:choose>
                    </tbody>
            ...
            <footer class="pagination-footer">
                <div class="pagination-info">Hiển thị <c:choose><c:when test="${not empty accounts}">1 - ${fn:length(accounts)}</c:when><c:otherwise>0</c:otherwise></c:choose> trong tổng số ${empty totalAccounts ? 0 : totalAccounts} tài khoản người dùng</div>
                <div class="pagination-nav"><button class="page-btn page-btn--wide disabled" disabled>Trước</button><button class="page-btn active">1</button><button class="page-btn page-btn--wide disabled" disabled>Sau</button></div>
            </footer>
        </section>
    ...
    <div class="modal-card" role="dialog" aria-modal="true">
        <form action="${ctx}/admin/accounts?action=save" method="POST">
            ...
            <div class="modal-body">
                <div style="margin-bottom:1.1rem; padding:0.6rem 0.9rem; border-radius:8px; background:#eff6ff; border:1px solid #bfdbfe; color:#1e40af; font-size:0.82rem;">Mật khẩu sẽ được <b>hệ thống sinh tự động</b> và hiển thị cho bạn <b>một lần</b> sau khi tạo. Người dùng phải đổi mật khẩu ở lần đăng nhập đầu tiên.</div>
                <div class="filter-grid" style="grid-template-columns:1fr 1fr; gap:1.25rem; margin-bottom:1.25rem;">
                    <div class="input-group"><label for="a_username" class="input-label">Tên đăng nhập <span style="color:#dc2626;">*</span></label><input type="text" id="a_username" name="username" class="input-field" maxlength="50" required></div>
                    <div class="input-group"><label for="a_role" class="input-label">Vai trò <span style="color:#dc2626;">*</span></label>
                        <select id="a_role" name="role" class="input-field" required><option value="">-- Chọn vai trò --</option><option value="Admin">Quản trị viên (Admin)</option><option value="ExamStaff">Cán bộ coi thi</option><option value="Examiner">Giám khảo chấm thi</option><option value="ManagingStaff">Cán bộ quản lý</option><option value="Registrant">Thí sinh</option></select></div>
                </div>
                <div class="input-group" style="margin-bottom:1.25rem;"><label for="a_email" class="input-label">Email <span style="color:#dc2626;">*</span></label><input type="email" id="a_email" name="email" class="input-field" maxlength="255" required></div>
                <div class="filter-grid" style="grid-template-columns:1fr 1fr; gap:1.25rem; margin-bottom:1.25rem;">
                    <div class="input-group"><label for="a_fullName" class="input-label">Họ và tên <span style="color:#dc2626;">*</span></label><input type="text" id="a_fullName" name="fullName" class="input-field" maxlength="255" required></div>
                    <div class="input-group"><label for="a_phone" class="input-label">Số điện thoại <span style="color:#dc2626;">*</span></label><input type="text" id="a_phone" name="phone" class="input-field" maxlength="10" required></div>
                </div>
                <div class="filter-grid" style="grid-template-columns:1fr 1fr 1fr; gap:1.25rem; margin-bottom:1.25rem;">
                    <div class="input-group"><label for="a_dob" class="input-label">Ngày sinh <span style="color:#dc2626;">*</span></label><input type="date" id="a_dob" name="dateOfBirth" class="input-field" required></div>
                    <div class="input-group"><label for="a_sex" class="input-label">Giới tính <span style="color:#dc2626;">*</span></label><select id="a_sex" name="sex" class="input-field" required><option value="">--</option><option value="Nam">Nam</option><option value="Nữ">Nữ</option><option value="Khác">Khác</option></select></div>
                    <div class="input-group"><label for="a_status" class="input-label">Trạng thái</label><select id="a_status" name="status" class="input-field"><option value="active">Hoạt động</option><option value="inactive">Khóa / Vô hiệu</option></select></div>
                </div>
                <div class="filter-grid" style="grid-template-columns:1fr 1.4fr; gap:1.25rem;">
                    <div class="input-group"><label for="a_govId" class="input-label">Số CCCD/CMND <span style="color:#dc2626;">*</span></label><input type="text" id="a_govId" name="govId" class="input-field" maxlength="12" required></div>
                    <div class="input-group"><label for="a_address" class="input-label">Địa chỉ</label><input type="text" id="a_address" name="address" class="input-field" maxlength="500"></div>
                </div>
            </div>
            <div class="modal-foot"><button type="button" class="btn-reset" onclick="closeAccModal()" style="height:44px; padding:0 1.5rem; display:inline-flex; align-items:center;">Hủy bỏ</button><button type="submit" class="btn-filter" style="height:44px; padding:0 1.5rem;">Tạo tài khoản</button></div>
        </form>
    </div>
</div>
...
<script>
    ...
    function lockAccount(id, name, lock) {
        var msg = lock ? ('Khóa tài khoản của "' + name + '"? Người dùng sẽ không đăng nhập được.') : ('Mở khóa tài khoản của "' + name + '"?');
    ...
    function resetAccount(id, username) {
        if (confirm('Cấp lại mật khẩu cho "' + username + '"?\nHệ thống sẽ sinh mật khẩu mới và người dùng phải đổi lại khi đăng nhập.')) { document.getElementById('resetId').value = id; document.getElementById('resetForm').submit(); }
    }
    function deleteAccount(id, name) {
        if (confirm('Xóa vĩnh viễn tài khoản của "' + name + '"?\nNếu tài khoản đã phát sinh dữ liệu, hệ thống sẽ không cho xóa — hãy dùng Khóa.')) { document.getElementById('delAccId').value = id; document.getElementById('delAccForm').submit(); }
    }
    function copyTmp() { var el = document.getElementById('tmpPw'); if (!el) return; navigator.clipboard.writeText(el.textContent).then(function(){ alert('Đã sao chép mật khẩu tạm.'); }); }
