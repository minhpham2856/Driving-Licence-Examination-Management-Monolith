    ...
    <main class="main-content">
        ...
        <header class="page-header">
            ...
            <div class="page-actions" style="display: flex; gap: 10px; align-items: center;">
                ...
                <button class="btn-export" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; background-color: #ffffff; color: #475569;" onclick="alert('Đang kết xuất báo cáo PDF chất lượng cao...');">
