...
<c:set var="detailUrl" value="${ctx}/views/examiner/candidate-details-edit" />
                            ...
                            <thead>
                                <tr>
                                    <th></th>
                                        ...
                                        <jsp:include page="/views/examiner/partials/sort-th.jsp"><jsp:param name="sortColumn" value="examDate" /><jsp:param name="label" value="Ngày thi" /></jsp:include>
                                ...
                                <c:choose>
                                    <c:when test="${empty candidates}">
                                        <tr><td colspan="8" class="examiner-table__empty">
                                                <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <tr<c:if test="${st.index % 2 == 1}"> class="examiner-table__row--alt"</c:if>>
                                                ...
                                                <td>${c.address}</td>
                                                <td><a href="${detailUrl}?sbd=${c.sbd}" class="examiner-btn examiner-btn--white examiner-btn--compact">Xem</a></td>
                                            </tr>
                                        </c:forEach>
                                    </c:otherwise>
                                </c:choose>
