                                        ...
                                        <td>
                                            <c:choose>
                                                ...
                                                <c:when test="${c.violationEligible}">
                                                    <a href="${pageContext.request.contextPath}/examiner/violation-confirm?sbd=${c.sbd}&amp;returnTo=${requestScope.pageUrl}" class="examiner-btn examiner-btn--danger examiner-btn--compact">Đình chỉ</a>
                                                </c:when>
                                                <c:otherwise>
