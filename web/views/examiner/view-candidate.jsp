                            ...
                            <div class="faceid-comparison-box">
                                <div class="face-photo-slot">
                                    <div class="face-photo-placeholder">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="opacity: 0.4;">
                                ...
                                <div class="face-photo-slot">
                                    <div class="face-photo-placeholder" style="border-color: ${candidateDetail.statusKey eq 'warning' ? '#cbd5e1' : '#10b981'};">
                                        ...
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="opacity: 0.4; color: ${candidateDetail.statusKey eq 'warning' ? '#64748b' : '#10b981'};">
