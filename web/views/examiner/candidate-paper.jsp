...
<c:set var="backUrl" value="${ctx}/examiner/candidate-details?sbd=${candidate.candidateNumber}" scope="request" />
<c:set var="pageUrl" value="${ctx}/examiner/candidate-paper?sbd=${candidate.candidateNumber}" scope="request" />
