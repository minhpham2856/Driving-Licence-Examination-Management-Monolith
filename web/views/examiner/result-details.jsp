    ...
    <main class="examiner-main examiner-main--dashboard">
        <section class="examiner-toolbar examiner-toolbar--tools">
            ...
            <div class="examiner-toolbar__group">
                ...
                <a href="${pageContext.request.contextPath}/views/examiner/result-details.jsp" class="examiner-btn examiner-btn--white examiner-btn--icon">
                ...
                <table class="examiner-table examiner-table--detail">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="examiner-table__center"><a href="${pageContext.request.contextPath}/views/examiner/result-details-edit.jsp" class="examiner-link-action">Sửa</a></td>
                        </tr>
