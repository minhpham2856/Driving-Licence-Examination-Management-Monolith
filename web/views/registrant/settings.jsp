                                ...
                                <div class="exam-details-rules-banner" style="margin-top: 0; margin-bottom: 20px; background-color: #fff5f5; border-left-color: #ef4444;">
                                    ...
                                    <div class="rules-banner__content">
                                        ...
                                        <p class="rules-banner__desc" style="color: #dc2626;">
                                            Tài khoản sẽ bị vô hiệu hóa và bạn không thể đăng nhập lại. Hồ sơ cá nhân, tài liệu (căn cước, giấy khám sức khỏe), đăng ký dự thi và lịch sử điểm vẫn được lưu trên hệ thống theo quy định Ban quản lý. Muốn khôi phục quyền truy cập, vui lòng liên hệ Ban quản lý.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <section class="p-form-card" aria-label="Tóm tắt tài khoản">
                            ...
                            <div class="p-form-body">
                                <div class="security-audit-list">
                                    ...
                                    <div class="security-audit-item">
                                        <span class="security-audit-lbl">ảnh căn cước</span>
