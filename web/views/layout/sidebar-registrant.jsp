...
<c:if test="${empty activeSidebar}">
    <c:choose>
        ...
        <c:when test="${fn:contains(pageContext.request.requestURI, 'my-exams') or fn:contains(pageContext.request.requestURI, 'schedule') or fn:contains(pageContext.request.requestURI, 'lich-thi') or fn:contains(pageContext.request.requestURI, 'result') or fn:contains(pageContext.request.requestURI, 'ket-qua')}">
...
<aside class="side-nav-bar" role="navigation" aria-label="Cổng thí sinh đăng ký">
    <div class="side-nav-bar__brand">
        <div class="side-nav-bar__brand-inner side-nav-bar__brand-inner--logo-only">
            <a href="${ctx}/registrant/dashboard" class="side-nav-bar__logo-link" aria-label="Lái Vui">
