        ...
        <main class="auth-split">
                ...
                <div class="auth-split__visual-inner">
                    ...
                    <div class="auth-split__copy">
                        <h1 class="auth-split__heading">
                            Hành trình vạn dặm<br><span>bắt đầu từ tay lái an toàn.</span>
                        </h1>
                        <p class="auth-split__sub">
                            Trung tâm đào tạo và sát hạch GPLX hiện đại.
                        </p>
            ...
            <section class="auth-split__form-pane">
                <div class="auth-split__form-inner">
                    ...
                    <%--case 3: registration credentials--%>
                    <c:if test="${not empty registrationUsername}">
                        <div class="auth-alert auth-alert--info" role="status">
                            ...
                            <p>
                                Tên đăng nhập:
                                <strong><c:out value="${registrationUsername}" /></strong>
                            </p>
                            <p>
                                Mật khẩu:
                                <strong><c:out value="${registrationPassword}" /></strong>
                            </p>
                        </div>
                    </c:if>
                    ...
                    <form class="login-form"
                        ...
                        <div class="form-group">
                            <label class="form-label" for="identifier">
                                Tên đăng nhập, Email hoặc số căn cước
                            </label>
                        ...
                        <div class="form-group">
                            <div class="form-label-row">
                                ...
                                <a href="${ctx}/forgot-password" class="forgot-password-link">
                                    Quên mật khẩu?
                                </a>
                            </div>
                            <div class="input-icon-wrapper">
