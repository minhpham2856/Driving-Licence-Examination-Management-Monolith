    ...
    <aside class="auth-split__visual auth-split__visual--register"
        ...
        <div class="auth-split__visual-inner">
            ...
            <div class="auth-split__copy">
                <h1 class="auth-split__heading">Đăng ký thi GPLX<br><span>dễ dàng, tiện lợi</span></h1>
                <p class="auth-split__sub">Đơn giản hoá hồ sơ, thủ tục và nhận kết quả nhanh chóng, chính xác.</p>
    ...
    <section class="auth-split__form-pane auth-split__form-pane--scroll">
        <div class="auth-split__form-inner">
            <header class="auth-split__form-header">
                ...
                <p>Điền thông tin cá nhân - hệ thống tạo tên đăng nhập và gửi qua email.</p>
            </header>
            ...
            <form class="register-form" action="${ctx}/register" method="POST" autocomplete="on">
                <div class="form-row-two-col">
                    <div class="form-group form-group--half">
                        <label class="form-label" for="govIdNo">Số căn cước</label>
                        <input class="form-input form-input--plain" type="text" id="govIdNo" name="govIdNo"
                               placeholder="001203012345" required maxlength="12" pattern="[0-9]{12}"
                               inputmode="numeric" autocomplete="off">
                    </div>
                    <div class="form-group form-group--half">
                        <label class="form-label" for="fullName">Họ và tên</label>
                        <input class="form-input form-input--plain" type="text" id="fullName" name="fullName"
                               placeholder="Nguyễn Văn Bình" required maxlength="200" autocomplete="name">
                    </div>
                </div>
                <div class="form-row-two-col">
                    <div class="form-group form-group--half">
                        <label class="form-label" for="phoneNo">Số điện thoại</label>
                        <input class="form-input form-input--plain" type="tel" id="phoneNo" name="phoneNo"
                               placeholder="0912345678" required maxlength="20" autocomplete="tel">
                    </div>
                    <div class="form-group form-group--half">
                        <label class="form-label" for="dateOfBirth">Ngày sinh</label>
                        <input class="form-input form-input--plain" type="date" id="dateOfBirth" name="dateOfBirth"
                               required autocomplete="bday" pattern='dd-MM-yyyy'>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label" for="address">Địa chỉ</label>
                    <input class="form-input form-input--plain" type="text" id="address" name="address"
                           placeholder="123 Lê Duẩn, Hà Nội" required maxlength="500" autocomplete="street-address">
                </div>
                <div class="form-row-two-col">
                    <div class="form-group form-group--half">
                        <label class="form-label" for="email">Email</label>
                        <input class="form-input form-input--plain" type="email" id="email" name="email"
                               placeholder="example@gmail.com" required autocomplete="email">
                    </div>
                    <div class="form-group form-group--half">
                        <label class="form-label" for="sex">Giới tính</label>
                        <select class="form-input form-input--plain" id="sex" name="sex" required>
