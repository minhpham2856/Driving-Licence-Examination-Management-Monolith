...
<c:choose>
    <c:when test="${useExamstaffShell}">
        ...
        <link rel="stylesheet" href="${ctx}/assets/css/examstaff/account.css?v=20260714c">
        <style>
        ...
        <c:when test="${useExaminerShell}">
            ...
            <html lang="vi">
                <head>
                    ...
                    <link rel="stylesheet" href="${ctx}/assets/css/examstaff/account.css?v=20260714c">
                    <style>
                        body.examiner-portal .examiner-main > .account-page--portal {
                            width: 100% !important;
                            max-width: none !important;
                            margin: 0 !important;
                            align-self: stretch !important;
                                                ...
                                                <div class="account-grid">
                                                    ...
                                                    <div class="account-field">
                                                        ...
                                                        <input class="account-input" type="date" id="dateOfBirth" name="dateOfBirth"
                                                               value="<fmt:formatDate value='${p.dateOfBirth}' pattern='dd-MM-yyyy' />">
                                                    </div>
                                                    <div class="account-field">
