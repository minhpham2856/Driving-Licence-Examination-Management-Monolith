    ...
    <main class="main-content">
        ...
        <header class="page-header">
            ...
            <div class="page-actions" style="display: flex; gap: 10px;">
                <a href="${pageContext.request.contextPath}/views/staff/exam/create-user.jsp" class="btn-filter" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; background-color: #0052cc; border-color: #0052cc;">
                    ...
                    Thêm học viên mới
                                ...
                                <a href="${pageContext.request.contextPath}/views/staff/exam/approve.jsp" class="btn-export" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; background-color: #ffffff; color: #475569;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                ...
                <div class="report-pane" style="padding: 1.5rem;">
                    <div class="grading-pane__header" style="border-bottom: none; margin-bottom: 1rem; padding-bottom: 0; display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <a href="${pageContext.request.contextPath}/views/staff/exam/approve.jsp" style="font-size: 0.8rem; font-weight: 700; color: #0052cc; text-decoration: none; display: inline-flex; align-items: center; gap: 4px;">
                                    ...
                                    <c:when test="${not empty recentSubmissions}">
                                        <c:forEach var="sub" items="${recentSubmissions}">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath}/views/staff/exam/approve.jsp?id=${sub.id}" class="btn-export" style="padding: 4px 10px; font-size: 0.78rem; border-radius: 6px; border-color: rgba(217, 119, 6, 0.25); color: #d97706; font-weight: 700; text-decoration: none;">Xem & Duyệt</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </c:when>
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                ...
                <div class="report-pane" style="padding: 1.5rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                        <a href="${pageContext.request.contextPath}/views/staff/exam/users.jsp" class="btn-export" style="text-decoration: none; padding: 1rem; border-radius: 8px; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 6px; box-sizing: border-box; width: 100%;">
                        ...
                        <a href="${pageContext.request.contextPath}/views/staff/exam/approve.jsp" class="btn-export" style="text-decoration: none; padding: 1rem; border-radius: 8px; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 6px; box-sizing: border-box; width: 100%;">
                        ...
                        <a href="${pageContext.request.contextPath}/views/staff/exam/users.jsp?filterStatus=active" class="btn-export" style="text-decoration: none; padding: 1rem; border-radius: 8px; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 6px; box-sizing: border-box; width: 100%;">
                        ...
                        <a href="${pageContext.request.contextPath}/views/staff/exam/create-user.jsp" class="btn-export" style="text-decoration: none; padding: 1rem; border-radius: 8px; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 6px; box-sizing: border-box; width: 100%;">
