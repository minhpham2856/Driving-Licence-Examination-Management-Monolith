                    ...
                    <c:when test="${not empty candidateDetail}">
                        <header class="page-header">
                            <div class="page-title-wrap">
                                ...
                                <p class="page-subtitle">Hồ sơ số báo danh ${candidateDetail.sbd} đăng ký sát hạch lái xe khóa thi ${candidateDetail.shiftLabel}.</p>
                            </div>
                            ...
                            <div class="page-actions" style="display: flex; gap: 10px;">
                                ...
                                <c:if test="${candidateDetail.statusKey eq 'success' or candidateDetail.statusKey eq 'danger'}">
                                    <a href="${pageContext.request.contextPath}/views/staff/exam/editscore.jsp" class="btn-filter" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; background-color: #0052cc; border-color: #0052cc;">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
