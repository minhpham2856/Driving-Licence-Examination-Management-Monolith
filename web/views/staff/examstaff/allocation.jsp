...
<c:set var="sidQ" value="${not empty param.sessionId ? '?sessionId='.concat(param.sessionId) : (not empty requestScope.examStaffLoadedSessionId ? '?sessionId='.concat(requestScope.examStaffLoadedSessionId) : '')}" />
...
<div class="allocation-overview-grid">
    <a href="${ctx}/views/staff/examstaff/allocation-waiting${sidQ}" class="allocation-overview-card allocation-overview-card--waiting">
    ...
    <a href="${ctx}/views/staff/examstaff/allocation-theory${sidQ}" class="allocation-overview-card allocation-overview-card--theory">
    ...
    <a href="${ctx}/views/staff/examstaff/allocation-practical${sidQ}" class="allocation-overview-card allocation-overview-card--practical">
    ...
    <a href="${ctx}/views/staff/examstaff/allocation-results-fail${sidQ}" class="allocation-overview-card allocation-overview-card--fail">
                ...
                <tbody>
                    <c:forEach var="hit" items="${allocationOverviewHits}" varStatus="st">
                        ...
                        <c:url var="stageUrl" value="${hit.stagePath}">
                            ...
                            <c:if test="${empty param.sessionId and not empty requestScope.examStaffLoadedSessionId}">
                                <c:param name="sessionId" value="${requestScope.examStaffLoadedSessionId}" />
                            </c:if>
                        </c:url>
                        <tr>
