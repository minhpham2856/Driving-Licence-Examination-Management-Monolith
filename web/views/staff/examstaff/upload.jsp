...
<div class="dashboard-shell">
    <main class="main-content">
        ...
        <jsp:include page="/views/layout/header-examstaff.jsp">
            <jsp:param name="pageTitle" value="Nhập danh sách thí sinh" />
        ...
        <header class="page-header">
            ...
            <div class="page-actions" style="display: flex; gap: 10px;">
                <a href="${ctx}/staff/examstaff/upload?action=downloadTemplate" class="btn-export" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; background-color: #ffffff; color: #0052cc; border-color: #0052cc; text-decoration: none; display: inline-flex; align-items: center; gap: 6px;">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Tải CSV Mẫu (.csv)
                </a>
                <a href="${ctx}/staff/examstaff/upload?action=downloadTestFile" class="btn-export" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; background-color: #ffffff; color: #10b981; border-color: #10b981; text-decoration: none; display: inline-flex; align-items: center; gap: 6px;">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
        ...
        <c:if test="${not empty sessionScope.uploadError}">
            <div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 12px; padding: 0.88rem 1.25rem; margin-bottom: 1.25rem; display: flex; gap: 8px; align-items: center;" class="animated shake">
                ...
                <span style="font-size: 0.85rem; font-weight: 600; color: #b91c1c;">
                    Định dạng tệp không hợp lệ hoặc cấu trúc không khớp chuẩn PC08. Chi tiết: ${sessionScope.uploadError}
                </span>
            </div>
        ...
        <!-- Preview table (Normal Flow Step 5) -->
        <c:if test="${param.preview eq 'true' and not empty sessionScope.previewCandidates}">
            <div class="preview-table-card animated fadeIn" style="margin-top: 1.5rem;">
                <form action="${ctx}/staff/examstaff/upload" method="GET" style="margin: 0;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #f1f5f9; padding-bottom: 1rem; margin-bottom: 1.25rem;">
                        ...
                        <div style="display: flex; gap: 10px;">
                            <a href="${ctx}/staff/examstaff/upload" class="btn-reset" style="height: 38px; padding: 0 1rem; font-size: 0.85rem; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; border: 1px solid #cbd5e1; border-radius: 8px; color: #475569;">Hủy bỏ</a>
                            <c:choose>
        ...
        <c:if test="${param.importSuccess eq 'true'}">
            <div style="background-color: #ecfdf5; border: 1px solid #10b981; border-radius: 12px; padding: 1.25rem; display: flex; gap: 12px; align-items: center; margin-top: 2rem; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.08);" class="animated slideInUp">
                ...
                <div>
                    ...
                    <p style="margin: 4px 0 0; font-size: 0.82rem; color: #047857;">Hệ thống đã lưu thành công <strong>${sessionScope.importedCount}</strong> học viên từ tệp CSV trích xuất PC08, kích hoạt trạng thái có mặt ở phòng chờ và tự động ghi nhật ký Audit Log kiểm toán.</p>
                </div>
            </div>
            <%
