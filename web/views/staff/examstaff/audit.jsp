...
<div class="dashboard-shell">
    <main class="main-content">
        ...
        <div class="staff-profile-card">
            <div class="profile-info-group">
                ...
                <div class="profile-meta-text">
                    <span style="font-size: 1.15rem; font-weight: 800;">${sessionScope.user.username}</span>
        ...
        <div style="background-color: #ffffff; border: 1px solid #cbd5e1; border-radius: 12px; padding: 15px; margin-top: 1.5rem; margin-bottom: 1.5rem; display: flex; justify-content: space-between; align-items: center; gap: 1rem; flex-wrap: wrap;">
            ...
            <form action="${ctx}/staff/examstaff/audit" method="GET" style="display: flex; align-items: center; gap: 10px; margin: 0;">
                ...
                <c:if test="${not empty param.filterDate}">
                    <a href="${ctx}/staff/examstaff/audit" style="font-size: 0.8rem; font-weight: 600; color: #ef4444; text-decoration: none; padding: 0 5px;">Xóa bộ lọc</a>
                </c:if>
            </form>
        </div>
        ...
        <section class="metrics-row" aria-label="Số liệu hoạt động cá nhân">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <span class="stat-number" style="color: #7e22ce;">${requestScope.procedureCount}</span>
                    <span class="stat-label">Hồ sơ / thủ tục đã xử lý</span>
                    <span class="stat-trend stat-trend--up">Thao tác thuộc nghiệp vụ Thanh toán & Hồ sơ</span>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <span class="stat-number" style="color: #10b981;">${requestScope.entityTypeCount}</span>
                    <span class="stat-label">Số loại nghiệp vụ đã thao tác</span>
                    <span class="stat-trend stat-trend--up">Đếm theo bảng đối tượng kiểm toán</span>
                </div>
            </div>
        </section>
                        ...
                        <c:if test="${empty requestScope.personalLogs}">
                            <tr>
                                <td colspan="5" style="text-align: center; color: #94a3b8; padding: 3rem;">
                                    Không có hoạt động thao tác nào của bạn được ghi nhận trên cơ sở dữ liệu.
                                </td>
                            </tr>
                        </c:if>
                    </tbody>
...
<script src="${ctx}/assets/js/audit.js"></script>
</body>
</html>
