...
<%-- Dòng tóm tắt kỳ thi: hạng - mã - ngày - giờ - trạng thái (dùng chung dashboard / phân bổ sát hạch viên). --%>
<p class="dashboard-exam-panel__desc">
    ...
    <c:if test="${param.showAllocatorLink eq 'true'}">
        <strong>${assignedExaminerUniqueCount}/${totalActiveExaminerCount}</strong> sát hạch viên đã phân công
        - <a href="examiner-allocation?examId=${sessionScope.selectedExamId}">Phân bổ sát hạch viên</a>.
    </c:if>
</p>
