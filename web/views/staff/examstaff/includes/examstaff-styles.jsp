...
<c:set var="cssEs" value="${ctx}/assets/css/examstaff" />

<link rel="stylesheet" href="${ctx}/assets/css/layout.css">
<link rel="stylesheet" href="${ctx}/assets/css/style.css">
<link rel="stylesheet" href="${cssEs}/base.css">
<link rel="stylesheet" href="${cssEx}/sidebar.css">
<link rel="stylesheet" href="${cssEs}/sidebar.css">
...
<link rel="stylesheet" href="${cssEs}/icons.css">
<link rel="stylesheet" href="${ctx}/assets/css/examstaff.css">
<link rel="stylesheet" href="${cssEs}/portal.css">

<c:if test="${not empty param.pageCss}">
    <c:forTokens items="${param.pageCss}" delims="," var="cssFile">
        <c:if test="${not empty fn:trim(cssFile)}">
            <link rel="stylesheet" href="${cssEs}/${fn:trim(cssFile)}">
        </c:if>
    </c:forTokens>
</c:if>
