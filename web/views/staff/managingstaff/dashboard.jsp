...
<header class="page-header"><div class="page-title-wrap"><h1 class="page-title">Dashboard Quản Lý</h1></div><div class="page-actions" style="display:flex;gap:.65rem"><a class="btn-export" href="${ctx}/manager/exam-schedules" style="text-decoration:none">Tạo phiên thi</a></div></header>
