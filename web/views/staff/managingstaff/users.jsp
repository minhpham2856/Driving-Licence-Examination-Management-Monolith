...
<head>
    ...
    <style>
        .registrant-filter-grid {
            grid-template-columns: repeat(4, minmax(120px, 1.15fr)) repeat(3, minmax(115px, 1fr)) minmax(180px, 1.35fr);
            gap: .75rem;
        }
        .registrant-filter-grid .filter-grid__btn-col {
            grid-column: auto;
        }
...
<main class="main-content">
    ...
    <section class="filter-panel">
        ...
        <form action="${ctx}/manager/registrants" method="get">
            <div class="filter-grid registrant-filter-grid">
                <div class="input-group">
                    <label class="input-label" for="govIdNo">CCCD</label>
                    <input class="input-field" id="govIdNo" name="govIdNo" value="<c:out value='${param.govIdNo}' />" placeholder="Nhập số CCCD">
                </div>
                <div class="input-group">
                    <label class="input-label" for="fullName">Họ và tên</label>
                    <input class="input-field" id="fullName" name="fullName" value="<c:out value='${param.fullName}' />" placeholder="Nhập họ và tên">
                </div>
                <div class="input-group">
                    <label class="input-label" for="email">Email</label>
                    <input class="input-field" id="email" name="email" value="<c:out value='${param.email}' />" placeholder="Nhập email">
                </div>
                <div class="input-group">
                    <label class="input-label" for="phoneNo">Số điện thoại</label>
                    <input class="input-field" id="phoneNo" name="phoneNo" value="<c:out value='${param.phoneNo}' />" placeholder="Nhập số điện thoại">
                </div>
                <div class="input-group">
                ...
                <c:choose>
                    <c:when test="${currentPage gt 1}">
                        <c:url var="previousUrl" value="/manager/registrants">
                            ...
                            <c:param name="govIdNo" value="${param.govIdNo}" />
                            <c:param name="email" value="${param.email}" />
                            <c:param name="phoneNo" value="${param.phoneNo}" />
