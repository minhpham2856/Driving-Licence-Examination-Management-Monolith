        ...
        <header class="page-header">
            ...
            <div class="page-actions" style="display: flex; gap: 10px;">
                ...
                <c:if test="${user.statusKey eq 'warning'}">
                    <a href="${pageContext.request.contextPath}/views/staff/managing/approve.jsp?id=${user.id}" class="btn-filter" style="height: 42px; padding: 0 1.25rem; font-size: 0.9rem; border-radius: 8px; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; background-color: #d97706; border-color: #d97706;">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="profile-grid">
            ...
            <c:otherwise>
                <div class="report-pane" style="padding: 5rem 1.5rem; text-align: center; color: #64748b; font-weight: 500; margin-top: 1.5rem;">
                    ...
                    <a href="${pageContext.request.contextPath}/views/staff/managing/users.jsp" class="btn-export" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; border: 1px solid #cbd5e1; border-radius: 8px; height: 42px; padding: 0 1.5rem; font-size: 0.9rem; font-weight: 600; color: #475569; background-color: #ffffff; margin-top: 1.5rem;">Quay lại danh sách</a>
                </div>
            </c:otherwise>
        </c:choose>
