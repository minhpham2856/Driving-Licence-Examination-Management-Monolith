...
<head>
    ...
    <style>
        * { box-sizing:border-box; }
        html, body { height:auto; min-height:100%; overflow-y:auto; margin:0; background:#eef2f7; }
        .qz-wrap { max-width:1200px; margin:1.5rem auto; padding:6rem 1rem 5rem; display:grid; grid-template-columns:1fr 320px; gap:1.25rem; font-family:'Inter',sans-serif; align-items:start; }
