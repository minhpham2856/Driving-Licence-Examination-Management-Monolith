        ...
        <div class="landing-container">
            <div class="hero-history-grid">
                <div class="hero-history-image-wrap">
                    <img class="hero-history-img" src="${pageContext.request.contextPath}/assets/imgs/history.png" alt="Lái Vui History">
                </div>
    ...
    <section class="landing-section facilities-section">
        <div class="landing-container">
            <div class="facilities-header">
                ...
                <p class="facilities-desc">Chúng tôi đầu tư không ngừng vào hạ tầng và trang thiết bị để mang lại trải nghiệm tốt nhất cho bạn.</p>
            </div>
            
            <div class="bento-grid">
                <!-- Large Left Item: Sân tập lái -->
                <div class="bento-left">
                    <div class="bento-bg" style="background-image: url('${pageContext.request.contextPath}/assets/imgs/facilities_track.png');"></div>
                    <div class="bento-overlay">
                        <h3 class="bento-card-title">Sân tập tiêu chuẩn</h3>
                        <p class="bento-card-desc">Diện tích 20.000m² với đầy đủ 11 bài thi sa hình, mô phỏng thực tế các tình huống giao thông phức tạp nhất.</p>
                    </div>
                </div>
                ...
                <div class="bento-right">
                    ...
                    <div class="bento-card-small">
                        <div class="bento-bg" style="background-image: url('${pageContext.request.contextPath}/assets/imgs/facilities_classroom.png');"></div>
                        <div class="bento-overlay bento-overlay-small">
                            <h3 class="bento-card-title">Hệ thống lái cabin</h3>
                            <p class="bento-card-desc">Học viên được làm quen với cabin ảo trước khi thực hành trên xe thật.</p>
                        </div>
                    </div>
                    
                    <!-- Bottom Item: Car fleet -->
                    <div class="bento-card-small">
                        <div class="bento-bg" style="background-image: url('${pageContext.request.contextPath}/assets/imgs/facilities_cars.png');"></div>
                        <div class="bento-overlay bento-overlay-small">
                            <h3 class="bento-card-title">Dàn xe tiêu chuẩn</h3>
                            <p class="bento-card-desc">Sử dụng các dòng xe phổ biến như Toyota Vios, Hyundai Accent được bảo dưỡng định kỳ.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="landing-container">
            ...
            <div class="instructor-grid">
                ...
                <div class="instructor-card">
                    <div class="instructor-img-wrap" style="background-image: url('${pageContext.request.contextPath}/assets/imgs/instructor_1.png');">
                ...
                <!-- Instructor Card 2 -->
                <div class="instructor-card">
                    <div class="instructor-img-wrap" style="background-image: url('${pageContext.request.contextPath}/assets/imgs/instructor_2.png');">
                ...
                <!-- Instructor Card 3 -->
                <div class="instructor-card">
                    <div class="instructor-img-wrap" style="background-image: url('${pageContext.request.contextPath}/assets/imgs/instructor_3.png');">
                ...
                <!-- Instructor Card 4 -->
                <div class="instructor-card">
                    <div class="instructor-img-wrap" style="background-image: url('${pageContext.request.contextPath}/assets/imgs/instructor_4.png');">
    ...
    <section class="landing-section">
        <div class="landing-container">
            <div class="cta-container">
                ...
                <p class="cta-desc">Gia nhập cộng đồng hơn 50.000 học viên đã tốt nghiệp tại Lái Vui và nhận chứng chỉ lái xe an toàn ngay hôm nay.</p>
